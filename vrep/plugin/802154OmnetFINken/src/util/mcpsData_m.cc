...
unsigned char mcpsDataReq::getMsduHandle() const
{
    return msduHandle_var;
}

void mcpsDataReq::setMsduHandle(unsigned char msduHandle)
{
...
simtime_t mcpsDataInd::getTimestamp() const
{
    return Timestamp_var;
}

void mcpsDataInd::setTimestamp(simtime_t Timestamp)
{
...
Register_Class(msduPayload);

msduPayload::msduPayload(const char *name, int kind) : ::cPacket(name,kind)
{
}

msduPayload::msduPayload(const msduPayload& other) : ::cPacket(other)
{
    copy(other);
}

msduPayload::~msduPayload()
{
}

msduPayload& msduPayload::operator=(const msduPayload& other)
{
    if (this==&other) return *this;
    ::cPacket::operator=(other);
    copy(other);
...
void msduPayload::copy(const msduPayload& other)
{
    this->payload_var = other.payload_var;
}

void msduPayload::parsimPack(cCommBuffer *b)
{
    ::cPacket::parsimPack(b);
    doPacking(b,this->payload_var);
}

void msduPayload::parsimUnpack(cCommBuffer *b)
{
    ::cPacket::parsimUnpack(b);
    doUnpacking(b,this->payload_var);
}

payloadVector& msduPayload::getPayload()
{
    return payload_var;
}

void msduPayload::setPayload(const payloadVector& payload)
{
    this->payload_var = payload;
}

class msduPayloadDescriptor : public cClassDescriptor
{
  public:
    msduPayloadDescriptor();
    virtual ~msduPayloadDescriptor();
...
Register_ClassDescriptor(msduPayloadDescriptor);

msduPayloadDescriptor::msduPayloadDescriptor() : cClassDescriptor("msduPayload", "cPacket")
{
}

msduPayloadDescriptor::~msduPayloadDescriptor()
{
}

bool msduPayloadDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<msduPayload *>(obj)!=NULL;
}

const char *msduPayloadDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int msduPayloadDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount(object) : 1;
}

unsigned int msduPayloadDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *msduPayloadDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int msduPayloadDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
...
const char *msduPayloadDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *msduPayloadDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int msduPayloadDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    msduPayload *pp = (msduPayload *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string msduPayloadDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool msduPayloadDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *msduPayloadDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: return opp_typename(typeid(payloadVector));
        default: return NULL;
    };
}

void *msduPayloadDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
unsigned char mcpsDataConf::getMsduHandle() const
{
    return msduHandle_var;
}

void mcpsDataConf::setMsduHandle(unsigned char msduHandle)
{
    this->msduHandle_var = msduHandle;
}
...
simtime_t mcpsDataConf::getTimestamp() const
{
    return Timestamp_var;
}

void mcpsDataConf::setTimestamp(simtime_t Timestamp)
{
    this->Timestamp_var = Timestamp;
}
...
mcpsPurgeReq::mcpsPurgeReq(const char *name, int kind) : ::cPacket(name,kind)
{
    this->msduHandle_var = 0;
}

mcpsPurgeReq::mcpsPurgeReq(const mcpsPurgeReq& other) : ::cPacket(other)
{
    copy(other);
}
...
unsigned char mcpsPurgeReq::getMsduHandle() const
{
    return msduHandle_var;
}

void mcpsPurgeReq::setMsduHandle(unsigned char msduHandle)
{
    this->msduHandle_var = msduHandle;
}
...
mcpsPurgeReqDescriptor::mcpsPurgeReqDescriptor() : cClassDescriptor("mcpsPurgeReq", "cPacket")
{
}
