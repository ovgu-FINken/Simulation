...
DisAssociation::DisAssociation(const char *name, int kind) : ::cPacket(name,kind)
{
...
DisAssociation::DisAssociation(const DisAssociation& other) : ::cPacket(other)
{
    copy(other);
}
...
DisAssociationDescriptor::DisAssociationDescriptor() : cClassDescriptor("DisAssociation", "cPacket")
{
}
...
Association::Association(const char *name, int kind) : ::cPacket(name,kind)
{
    this->SecurityLevel_var = 0;
    this->KeyIdMode_var = 0;
    this->KeySource_var = 0;
...
Association::Association(const Association& other) : ::cPacket(other)
{
    copy(other);
}
...
AssociationDescriptor::AssociationDescriptor() : cClassDescriptor("Association", "cPacket")
{
}
...
unsigned short AssociationRequest::getCoordPANId() const
{
    return CoordPANId_var;
}

void AssociationRequest::setCoordPANId(unsigned short CoordPANId)
{
...
std::string AssociationRequestDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return ulong2string(pp->getCoordPANId());
...
GTSMessage::GTSMessage(const char *name, int kind) : ::cPacket(name,kind)
{
    this->SecurityLevel_var = 0;
    this->KeyIdMode_var = 0;
    this->KeySource_var = 0;
...
GTSMessage::GTSMessage(const GTSMessage& other) : ::cPacket(other)
{
    copy(other);
}
...
GTSMessageDescriptor::GTSMessageDescriptor() : cClassDescriptor("GTSMessage", "cPacket")
{
}
...
GTSConfirm::GTSConfirm(const char *name, int kind) : ::cPacket(name,kind)
{
    this->status_var = 0;
}

GTSConfirm::GTSConfirm(const GTSConfirm& other) : ::cPacket(other)
{
    copy(other);
}
...
GTSConfirmDescriptor::GTSConfirmDescriptor() : cClassDescriptor("GTSConfirm", "cPacket")
{
}
