...
// cplusplus {{
	...
	#include <vector>
	typedef std::vector<unsigned char> payloadVector; 
	inline std::ostream & operator << (std::ostream & os, const unsigned char & s) {
        std::operator<<(os, s);        
        return os;
	}
// }}
...
/**
 * Class generated from <tt>util/mcpsData.msg:39</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>util/mcpsData.msg:54</tt> by nedtool.
 * <pre>
 ...
 * </pre>
 */
class msduPayload : public ::cPacket
{
  protected:
    payloadVector payload_var;

  private:
    void copy(const msduPayload& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const msduPayload&);

  public:
    msduPayload(const char *name=NULL, int kind=0);
    msduPayload(const msduPayload& other);
    virtual ~msduPayload();
    msduPayload& operator=(const msduPayload& other);
    virtual msduPayload *dup() const {return new msduPayload(*this);}
    virtual void parsimPack(cCommBuffer *b);
    virtual void parsimUnpack(cCommBuffer *b);

    // field getter/setter methods
    virtual payloadVector& getPayload();
    virtual const payloadVector& getPayload() const {return const_cast<msduPayload*>(this)->getPayload();}
    virtual void setPayload(const payloadVector& payload);
};

inline void doPacking(cCommBuffer *b, msduPayload& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, msduPayload& obj) {obj.parsimUnpack(b);}

/**
 * Class generated from <tt>util/mcpsData.msg:67</tt> by nedtool.
 * <pre>
 * packet mcpsDataConf
 * {
...
/**
 * Class generated from <tt>util/mcpsData.msg:74</tt> by nedtool.
 * <pre>
 * packet MaUnitdata
 * {
 *     MACAddressExt SrcAddr;
...
/**
 * Class generated from <tt>util/mcpsData.msg:83</tt> by nedtool.
 * <pre>
 * packet mcpsPurgeReq
 * {
 *     unsigned char msduHandle;          // 0x00–0xff  -->  actually just an unsigned char 8-Bit value but mapping to OMNeT msg ID requires long
...
/**
 * Class generated from <tt>util/mcpsData.msg:87</tt> by nedtool.
 * <pre>
