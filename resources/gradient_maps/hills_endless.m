%creates a gradient map with some randomly placed hills (quartic) and
%makes sure the edges fit together to be able to loop around endlessly
% R: height
...
% easily turn on and off 3D visualization
visualize = true;
