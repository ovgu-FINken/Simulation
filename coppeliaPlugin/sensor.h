...
class Sensor {
  ...
  public:
     ...
     */
    Sensor(int sensorHandle, double sigma, boost::random::mt19937& gen)
      : handle(sensorHandle), sigma(sigma),
        dist(boost::random::uniform_real_distribution<> {-sigma, sigma}), gen(gen) {
    };
