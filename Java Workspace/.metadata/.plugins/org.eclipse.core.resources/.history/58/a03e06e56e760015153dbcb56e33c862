...
/**
 * an <code>AbsFileChooserPanel</code> that chooses the telemetry file.
 * 
 * @author Vladimir Velinov
 * @since Oct 11, 2015
 *
 */
public class TelemetryFileChooserPanel extends AbsFileChooserPanel {
  
  private JLabel label;
  private JLabel fileLabel;
  
  private void _initComponents() {
    this.label     = new JLabel(UIConstants.LBL_TELEMETRY_FILE);
  ...
  protected String getBorderTitle() {
    return UIConstants.BORDER_TELEMETRY;
  }
  ...
  protected String getSavedFileName() {
    return "TelemetryPath.txt";
  }

  @Override
  protected String getFileSaverKey() {
    return FilePathSaver.TELEMETRY_PATH;
  }
