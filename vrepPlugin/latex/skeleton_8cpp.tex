...
Function to register any F\+I\+Nken present in the vrep scene with the plugin. Every copter needs to call this in its child script to be accesible by the plugin. Stores the handle, aricraft\+ID, rotor and sonar counts in \hyperlink{skeleton_8cpp_simFinken}{sim\+Finken} 
